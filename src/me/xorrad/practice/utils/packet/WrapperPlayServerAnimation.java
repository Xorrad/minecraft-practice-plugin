...
package me.xorrad.practice.utils.packet;
...
public class WrapperPlayServerAnimation extends AbstractPacket {
	...
	public static class Animations extends IntEnum {
		public static int SWING_ARM = 0;
		public static int DAMAGE_ANIMATION = 1;
		public static int LEAVE_BED = 2;
		public static int EAT_FOOD = 3;
		public static int CRITICAL_EFFECT = 4;
		public static int MAGIC_CRITICAL_EFFECT = 5;
		public static int UNKNOWN = 102;
		public static int CROUCH = 104;
		public static int UNCROUCH = 105;
	...
	public static PacketType TYPE = PacketType.Play.Server.ANIMATION;
